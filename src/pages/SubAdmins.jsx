...
const SubAdmins = () => {
  ...
  const canManageThisType = ["super_admin", "super_sub_admin", "admin"].includes(user?.role);
  const userSocietyId =
  ...
  const canCreateSubAdmin = user?.role === "admin" ? (planLimits.maxSubAdmins > currentSubAdminCount || !planLimits.maxSubAdmins) : true;
    ...
    <div className="page-container">
      <div className="page-header">
        ...
        <div className="action-buttons-group">
          ...
          {canManageThisType && (
            <button className="btn btn-primary" onClick={handleOpenCreate} disabled={!canCreateSubAdmin} title={!canCreateSubAdmin ? "Limit reached" : ""}>
        ...
        <div className="modal-overlay custom-modal-overlay">
          <div className="modal-content custom-modal-content" style={{ maxWidth: '400px', textAlign: 'center' }}>
            ...
            <div style={{ padding: '20px' }}>
              ...
              <h2 style={{ marginBottom: '8px', color: '#111827', fontSize: '1.25rem' }}>Credentials Generated Successfully</h2>
              ...
              <p style={{ color: '#10b981', fontSize: '0.85rem', marginBottom: '24px' }}>
                {licenseModalData.emailSent ? `Email sent to ${licenseModalData.email} with login credentials.` : `Failed to send email to ${licenseModalData.email}. Please provide credentials manually.`}
              </p>
