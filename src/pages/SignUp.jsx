...
const SignUp = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Pass phone and optional dev OTP hint to /verify-otp page
      navigate('/verify-otp', {
        state: {
          phone: phone.trim(),
          otpHint: res?.otp,
      ...
      if (err.response?.status === 409) {
        ...
        setErrorMsg('A Super Admin account already exists for this system. Please log in instead.');
      } else {
      ...
      <div className="login-container">
        <div className="login-card">
          <div className="login-header">
            ...
            <p className="login-subtitle">Register Single Super Admin Account for IntefAI Security</p>
          </div>
